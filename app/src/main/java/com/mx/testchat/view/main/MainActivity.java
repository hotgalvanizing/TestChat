...
import com.mx.testchat.AppConst;
import com.mx.testchat.nimsdk.AuthBroadcastReceiver;
import com.mx.testchat.nimsdk.NimAccountSDK;
import com.mx.testchat.nimsdk.NimFriendSDK;
import com.mx.testchat.nimsdk.NimSystemSDK;
import com.mx.testchat.nimsdk.NimTeamSDK;
import com.mx.testchat.nimsdk.NimUserInfoSDK;
import com.mx.testchat.nimsdk.custom.CustomAttachParser;
import com.mx.testchat.utils.StringUtils;
...
import com.mx.testchat.view.main.adapter.MainPagerAdapter;
import com.mx.testchat.view.menu.NewFriendActivity;
import com.mx.testchat.view.menu.ScanActivity;
import com.mx.testchat.view.menu.TeamCheatCreateActvitiy;
import com.mx.testchat.view.menu.WebViewActivity;
import com.mx.testchat.view.options.SearchUserActivity;
import com.mx.testchat.view.weight.PopupWindowFactory;
...
public class MainActivity extends BaseActivity {
    ...
    /**
     * 是否要合并好友申请，同一个用户仅保留最近一条申请内容（默认不合并）
     */
    ...
    private void showMenu() {
        ...
        mPopupWindow = PopupWindowFactory.getPopupWindowAtLocation(menuView, mVpContent,
                Gravity.RIGHT | Gravity.TOP, UIUtils.dip2Px(12),
                mToolbar.getHeight() + getStatusBarHeight());
    }
