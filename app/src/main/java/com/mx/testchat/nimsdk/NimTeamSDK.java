...
import static com.netease.nimlib.sdk.team.constant.TeamMessageNotifyTypeEnum.Mute;
...
public class NimTeamSDK {
     ...
     */
    //TODO 参数有调整
    public static void createTeam(HashMap<TeamFieldEnum, Serializable> fields,
                                  TeamTypeEnum type, List<String> accounts,
     ...
     */
    //TODO 参数有调整
    public static void addMembers(String teamId, List<String> accounts, RequestCallback<List<String>> callback) {
     ...
     */
    //TODO 参数有调整
    public static void observeMemberRemove(Observer<List<TeamMember>> memberRemoveObserver, boolean register) {
    ...
    public static String getTeamMemberDisplayNameWithYou(String tid, String account) {
        ...
        if (account.equals(UserCacheUtil.getAccount())) {
            return "你";
        }
    ...
    public static void setShouldShowNickName(String teamId, boolean shouldShowNickName, RequestCallback<Void> callback) {
        TeamMember member = queryTeamMemberBlock(teamId, UserCacheUtil.getAccount());
        if (member != null) {
