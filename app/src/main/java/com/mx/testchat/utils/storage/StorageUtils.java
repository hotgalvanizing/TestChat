package com.mx.testchat.utils.storage;
...
import com.mx.testchat.utils.storage.ExternalStorage;
import com.mx.testchat.utils.storage.StorageType;

import java.io.File;

/**
 * 存储区工具类(与ExternalStorage、StorageType一起使用)
 */
